...
namespace WebAppInca.Controllers
{
    public class ServiciosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TipoServ,Descripcion")] Servicio servicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TipoServ,Descripcion")] Servicio servicio)
        {
            if (id != servicio.Id)
            {
                return NotFound();
