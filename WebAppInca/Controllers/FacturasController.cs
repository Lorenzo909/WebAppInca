...
namespace WebAppInca.Controllers
{
    public class FacturasController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Factura.Include(f => f.Cuenta).Include(f => f.Proveedor);
        ...
        public async Task<IActionResult> Create([Bind("Id,Consecutivo,Monto,FechaEmicion,CuentaId,ProveedorId")] Factura factura)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Consecutivo,Monto,FechaEmicion,CuentaId,ProveedorId")] Factura factura)
        {
            if (id != factura.Id)
            {
                return NotFound();
